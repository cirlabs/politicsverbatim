...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('base_document', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Document.status'
        db.delete_column('base_document', 'status')
