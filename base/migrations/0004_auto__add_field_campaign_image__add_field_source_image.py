...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('base_campaign', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Source.image'
        db.add_column('base_source', 'image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.image'
        db.delete_column('base_campaign', 'image')

        # Deleting field 'Source.image'
        db.delete_column('base_source', 'image')
