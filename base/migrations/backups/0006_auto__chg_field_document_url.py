...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('base_document', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Document.url'
        db.alter_column('base_document', 'url', self.gf('django.db.models.fields.URLField')(unique=True, max_length=200, null=True, blank=True))
    ...
    models = {
        ...
        'base.document': {
            ...
            'url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'unique': 'True', 'null': 'True'})
        },
        'base.documenttype': {
