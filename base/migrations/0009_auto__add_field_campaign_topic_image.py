...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Campaign.topic_image'
        db.add_column('base_campaign', 'topic_image', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Campaign.topic_image'
        db.delete_column('base_campaign', 'topic_image')
    ...
    models = {
        'base.campaign': {
            ...
            'topic_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'blank': 'True'})
        },
        'base.campaigntopic': {
